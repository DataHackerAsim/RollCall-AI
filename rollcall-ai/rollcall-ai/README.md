...
**RollCall AI runs entirely on your own machine.** Biometrics never leave the server you installed it on. The source is here; you can read every line.
...
│
├── rollcall/                           # Django project package
